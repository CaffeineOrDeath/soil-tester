...
\label{md_soil_2code_2sampler_2sampler_autotoc_md22}%
\Hypertarget{md_soil_2code_2sampler_2sampler_autotoc_md22}%


The {\ttfamily Sampler} portion of this project is responsible for extracting and storing the soil sample in a sterile tube. The {\ttfamily Sampler} will handle the control of a motor. This motor will either be weighted offset from the shaft to add vibration to drive the extractor and/or a single drive system, like an extruder for a 3D printer. This should contain enough force to move the tube down into the soil.\hypertarget{md_soil_2code_2sampler_2sampler_autotoc_md23}{}\doxysection{\texorpdfstring{Plan}{Plan}}\label{md_soil_2code_2sampler_2sampler_autotoc_md23}
